...
public class Base 
{
	...
	public static void browser(String s) 
	{
		...
		{
			System.setProperty("webdriver.edge.driver","C:\\Users\\Gopi\\eclipse-workspace\\com.cucumber\\Driver\\msedgedriver.exe");
	...
	public static void screenshot(String s) throws IOException 
	{
		...
		File F = new File("C:\\Users\\Gopi\\eclipse-workspace\\CucumberBDD\\Screenshots\\"+s+".png");
